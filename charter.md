...
*	4. 	[Scope](#4-scope)  
    ...
    *	4.5 	[Steering Committee](#45-steering-committee)  
    *	4.6 	[Membership](#46-membership)  
*	5. 	[Assumptions, Constraints, And Risks](#5-assumptions-constraints-and-risks)  
    *	5.1 	[Assumptions](#51-assumptions) 
    *	5.2 	[Constraints](#52-constraints) 
    *	5.3   [Risks](#53-risks)
 *	6. 	[Community Organization](#6-community-organization)   
    *	6.1   [Roles and Responsibilities](#61-roles-and-responsibilities)
    *	6.2   [Stakeholders (Internal & External)](#62-stakeholders-internal--external)
*  7.    [Community Charter Approval](#7-community-charter-approval)
